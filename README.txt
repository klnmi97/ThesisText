...
Univerzity Palackého v Olomouci (KI PřF UP v Olomouci) v typografickém
systému LaTeX, včetně ukázkového textu práce, který je zároveň
dokumentací stylu.
...
dodatečné styly (balíky), které, pokud nejsou součástí standardní
instalace distribuce, lze v rámci distribuce doinstalovat:
...
Chyby v souvislosti s tímto použitím reportuje na kontakt níže.
