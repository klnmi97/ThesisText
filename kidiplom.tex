...
As an example, we will consider the algorithm for finding factorial representing it in pseudocode and by the flowchart(Figure \ref{fig:flowchart}).
...
Complete source codes of the program "Sorting-Visualization".
